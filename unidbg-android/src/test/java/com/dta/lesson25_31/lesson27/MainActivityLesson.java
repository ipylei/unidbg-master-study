...
public class MainActivityLesson {
    ...
    public MainActivityLesson(){
        ...
        DalvikModule dalvikModule = vm.loadLibrary(new File("unidbg-android/src/test/java/com/dta/lesson25_31/lesson27/libcyberpeace.so"), false);

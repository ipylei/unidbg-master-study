...
public class L34JNIDogLite extends AbstractJni implements IOResolver<AndroidFileIO> {
    ...
    public static void main(String[] args) {
        ...
        L34JNIDogLite l34JniDogLite = new L34JNIDogLite();
        l34JniDogLite.detectFile();
        l34JniDogLite.detectFileNew();
        l34JniDogLite.SysInfo();
        l34JniDogLite.getAppFilesDir();
        l34JniDogLite.base64result();

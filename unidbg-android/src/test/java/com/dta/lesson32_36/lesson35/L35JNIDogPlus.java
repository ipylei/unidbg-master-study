...
public class L35JNIDogPlus extends AbstractJni implements IOResolver<AndroidFileIO> {
    ...
    public static void main(String[] args) {
        ...
        L35JNIDogPlus l35JniDogPlus = new L35JNIDogPlus();
        l35JniDogPlus.detectAccessibilityManager();
    ...
    public DvmObject<?> callObjectMethodV(BaseVM vm, DvmObject<?> dvmObject, String signature, VaList vaList) {
        ...
        if (signature.equals("android/view/accessibility/AccessibilityManager->getInstalledAccessibilityServiceList()Ljava/util/List;")) {
            ...
            //return ProxyDvmObject.createObject(vm, dvmObjects); //不可以，更准确说如果这样做，则下一步需要重写父类方法。因为AbstractJni.java中对实现.size()、.get(index)等方法使用的是ArrayListObject。

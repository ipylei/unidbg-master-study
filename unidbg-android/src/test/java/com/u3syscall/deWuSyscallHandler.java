...
public class deWuSyscallHandler extends ARM32SyscallHandler {
    ...
    protected int ioctl(Emulator<?> emulator) {
        ...
        //Method pioctl = ARM32SyscallHandler.class.getDeclaredMethod("ioctl", Emulator.class);
        //pioctl.setAccessible(true);
        //return (int) pioctl.invoke(this, emulator);
    }
}

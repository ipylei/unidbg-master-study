...
public class ARM {
    ...
    *
    *
    * Alignment align = ARM.align(4090, 100, 4096);   //横跨了1页，address=0, size=8192
    * Alignment align = ARM.align(0x1020, 100, 4096); //未横跨页，address=4096, size=4096
    *
    ...
    * align：对齐单位
     ...
     long l = ARM.alignSize(4095, 4096);   //return: 0
     long l = ARM.alignSize(4097, 4096);   //return: 8192
    */
